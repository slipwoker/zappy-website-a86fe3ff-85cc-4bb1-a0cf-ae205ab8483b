document.addEventListener('DOMContentLoaded', function() {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(function() {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; background: #d4edda; border-radius: 4px; margin-top: 1rem;';
    ...
    const animatedElements = document.querySelectorAll('[data-animate], .fade-in, .fade-in-up, .fade-in-left, .fade-in-right');
        ...
        const animationObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    ...
                    if (entry.target.hasAttribute('data-animate-delay')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a86fe3ff-85cc-4bb1-a0cf-ae205ab8483b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a86fe3ff-85cc-4bb1-a0cf-ae205ab8483b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a86fe3ff-85cc-4bb1-a0cf-ae205ab8483b';
